        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            <div className="flex ">
              ...
              <Link to='#'  className="text-white hover:underline mr-1"
              >
              Ajit kumar
              </Link>
            </div>
          ...
          <div className="flex items-center">
            <a href="#" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300"  rel="noopener noreferrer">
              <ImLinkedin2 size={17} />
            </a>
            <a href="#" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300"  rel="noopener noreferrer">
              <ImGithub size={17} />
